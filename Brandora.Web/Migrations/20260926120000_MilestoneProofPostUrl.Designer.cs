...
namespace Brandora.Web.Migrations
{
    ...
    [Migration("20260926120000_MilestoneProofPostUrl")]
    partial class MilestoneProofPostUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Brandora.Web.Models.Domain.Campaign", b =>
                {
                    ...
                    b.Property<string>("SocialPostUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Brandora.Web.Models.Domain.ContactSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Brandora.Web.Models.Domain.Milestone", b =>
                {
                    ...
                    b.Property<string>("ProofPostUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Brandora.Web.Models.Domain.PlatformWalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RecipientBrandProfileId")
                        .HasColumnType("integer");

                    b.Property<int?>("RecipientInfluencerProfileId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecipientBrandProfileId");

                    b.HasIndex("RecipientInfluencerProfileId");
            ...
            modelBuilder.Entity("Brandora.Web.Models.Domain.PlatformWalletTransaction", b =>
                {
                    ...
                    b.HasOne("Brandora.Web.Models.Domain.BrandProfile", "RecipientBrandProfile")
                        .WithMany()
                        .HasForeignKey("RecipientBrandProfileId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Brandora.Web.Models.Domain.InfluencerProfile", "RecipientInfluencerProfile")
                        .WithMany()
                        .HasForeignKey("RecipientInfluencerProfileId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Dispute");

                    b.Navigation("RecipientBrandProfile");

                    b.Navigation("RecipientInfluencerProfile");
                });
